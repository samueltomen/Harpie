...
export default function NavBar() {
  return (
    <nav class="navbar navbar-expand-md navbar-light bg-custom">
                  <div class="container">
                  <Link to="/"><a id="1" class="navbar-brand" href="#"  onClick={colorChangeLink} aria-current="page"><img src={logo} alt="logo harpie" width="55px"/></a></Link>
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavId">
                        <ul id='navbarlink' class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <a id="3" class="nav-link" href="#" onClick={colorChangeLink}>Le saviez-vous</a>
                            </li>
                            <li class="nav-item">
                                <a id="4" class="nav-link"  href="#" onClick={colorChangeLink}>Nos histoires</a>
                            </li>
                            <li class="nav-item">
                                <a id="5" class="nav-link"  href="#" onClick={colorChangeLink}>Faites un don</a>
                            </li>
...
const activeLink = document.querySelector(".activey")
